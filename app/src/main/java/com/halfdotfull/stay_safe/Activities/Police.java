...
import com.halfdotfull.stay_safe.Model.PlaceDetail;
import com.halfdotfull.stay_safe.Model.Request;
import com.halfdotfull.stay_safe.Model.PoliceDetail;
...
public class Police extends AppCompatActivity {
    ...
    private void populateArray() {
        JsonObjectRequest jsonRequest = new JsonObjectRequest(
                "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+ MessageService.latitude+","+MessageService.longitude+
                        "&radius=2000&type=police&key=AIzaSyBgEqbEuZ8LJdG7BmDXn3frx89AK1IVd0c",
                null,
